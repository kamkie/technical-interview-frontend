...
> **Artifact role:** Learnings (lifecycle spec §7). **Lens owner:** `Capture-Learning` (§3.11) and the `Capture-Learning` cross-cutting trigger (§6).
...
- review during the `Retrospect` lens (`ROADMAP.md` Continuous Improvement)
