...
This index points humans to the durable documentation owners for the frontend repository.

| Need                                                    | Read                                                        |
| ------------------------------------------------------- | ----------------------------------------------------------- |
| Project overview and current surface                    | [`README.md`](../README.md)                                 |
| Product and design intent                               | [`docs/DESIGN.md`](DESIGN.md)                               |
...
Use the smallest owner that covers the change. Put product and design intent in `docs/DESIGN.md`, setup commands and local troubleshooting in `docs/LOCAL_DEVELOPMENT.md`, lifecycle and artifact-routing rules in `docs/DEVELOPMENT_LIFECYCLE.md`, AI collaboration guidance in `docs/WORKING_WITH_AI.md`, selected roadmap scope, status, dependencies, release context, and product non-goals in `ROADMAP.md`, and completed roadmap summaries in `docs/ROADMAP_ARCHIVE.md`.

Do not duplicate full procedures in entry-point docs. Link to the owner and update the owner when the procedure changes.
