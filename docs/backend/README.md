...
This directory holds imported backend contract artifacts for frontend agents and frontend tooling.
...
- `approved-openapi.json` from backend `src/test/resources/openapi/approved-openapi.json`
...
Do not edit imported copies by hand. If an imported file conflicts with the backend repository, refresh this directory or update the backend source first.
