...
- The active roadmap now uses stable IDs. `M-UI-001` is ready, `M-WORKFLOW-001` waits on it, `M-SMOKE-001` waits on workflow polish, and `M-QUALITY-001` is blocked on thresholds, owners, or repeatable evidence.
